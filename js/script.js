document.addEventListener("DOMContentLoaded", () => {
  ...
  const fetchPeliculas = async () => {
    ...
    peliculas.forEach((pelicula) => {
      ...
      row.innerHTML = `
                ...
                <td>
                    <button onclick="editPelicula(${pelicula.id}, '${pelicula.titulo}', ${pelicula.anioEstreno}, ${pelicula.categoriaId}, ${pelicula.duracion})">Editar</button>
  ...
  form.addEventListener("submit", (e) => {
    ...
    const pelicula = { titulo, anioEstreno, categoriaId, duracion }; // {"nombre": <<nombre>> , "cantidad":<<cantidad>>, "precio":precio}
